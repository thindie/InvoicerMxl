...
const val invoiceCentralScreenHint: String =
    "Здесь мы должны сначала загрузить txt файл с центральной базы в форме наименование - код, \n" +
            "затем должны сделать инвентаризацию своего склада, \n" +
            "и соеденить эти данные в заказ."